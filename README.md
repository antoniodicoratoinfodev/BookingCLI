...
* memory management and I/O in Java;
* testing and debugging techniques on small-scale projects.

This repository is therefore ideal as a laboratory project or as an example for university/academic courses.
...
* Packaging and distribution system (Maven/Gradle).
...
* gestione della memoria e operazioni di I/O in Java;
* tecniche di testing e debugging su progetti di piccole dimensioni.

Questo repository è quindi ideale come progetto di laboratorio o come esempio per corsi universitari e accademici.
...
* Test automatizzati (JUnit).
* Sistema di packaging e distribuzione (Maven/Gradle).
